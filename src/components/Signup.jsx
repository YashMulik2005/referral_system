...
function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await axios.post("https://referral-system-backend-theta.vercel.app/user/signup", { username: username, password: password, email: email, referredby: referredby });
        console.log(res);
